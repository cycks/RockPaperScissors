	...
	let findRoundWinner = function(playerScore, computerScore){
		...
		if (playerScore > computerScore) {
			toDisplay = document.getElementsByClassName("playerWins")[0];
			toDisplay.style.display = "grid";
			document.getElementById("displayPlayScore").innerHTML = playerWins;
		} else if (playerScore < computerScore){
			toDisplay = document.getElementsByClassName("compWins")[0];
			toDisplay.style.display = "grid";
			document.getElementById("displayCompScore").innerHTML = compWins;
		} else{
			toDisplay = document.getElementsByClassName("noWinner")[0]
			toDisplay.style.display = "grid";
